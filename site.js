...
window.PRODUCTS = [
  ...
  { slug:'high-top-sneaker-bred-toe', cat:'sneakers', stock:'in', brand:'High-Top Sneaker', name:'Bred Toe', grade:'Standard', img:'assets/Sneakers/high-top-sneaker-bred-toe.webp' },
  ...
  { slug:'low-top-sneaker-black-white', cat:'sneakers', stock:'in', brand:'Low-Top Sneaker', name:'Black & White', grade:'Entry', img:'assets/Sneakers/low-top-sneaker-black-white.webp' },
  ...
  { slug:'skate-low-panda', cat:'sneakers', stock:'in', brand:'Skate Low', name:'Panda', grade:'Standard', img:'assets/Sneakers/skate-low-panda.webp' },
  { slug:'court-sneaker-triple-white', cat:'sneakers', stock:'in', brand:'Court Sneaker', name:'Triple White', grade:'Entry', img:'assets/Sneakers/court-sneaker-triple-white.webp' },
  ...
  { slug:'low-top-sneaker-mocha', cat:'sneakers', stock:'in', brand:'Low-Top Sneaker', name:'Mocha', grade:'Vault', img:'assets/Sneakers/low-top-sneaker-mocha.webp' },
  ...
  { slug:'terrace-sneaker-white-black', cat:'sneakers', stock:'in', brand:'Terrace Sneaker', name:'White Black', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-white-black.webp' },
  ...
  { slug:'terrace-sneaker-black', cat:'sneakers', stock:'in', brand:'Terrace Sneaker', name:'Black', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-black.webp' },
  { slug:'terrace-sneaker-dark-green', cat:'sneakers', stock:'in', brand:'Terrace Sneaker', name:'Dark Green', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-dark-green.webp' },
  { slug:'retro-trainer-black-white', cat:'sneakers', stock:'in', brand:'Retro Trainer', name:'Black White', grade:'Entry', img:'assets/Sneakers/retro-trainer-black-white.webp' },
  { slug:'retro-runner-cream-navy', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Cream Navy', grade:'Standard', img:'assets/Sneakers/retro-runner-cream-navy.webp' },
  { slug:'retro-runner-cream-maroon', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Cream Maroon', grade:'Standard', img:'assets/Sneakers/retro-runner-cream-maroon.webp' },
  { slug:'retro-runner-black-cream', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Black Cream', grade:'Standard', img:'assets/Sneakers/retro-runner-black-cream.webp' },
  { slug:'retro-runner-black', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Black', grade:'Standard', img:'assets/Sneakers/retro-runner-black.webp' },
  { slug:'retro-runner-white', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'White', grade:'Standard', img:'assets/Sneakers/retro-runner-white.webp' },
  { slug:'court-sneaker-triple-black', cat:'sneakers', stock:'in', brand:'Court Sneaker', name:'Triple Black', grade:'Entry', img:'assets/Sneakers/court-sneaker-triple-black.webp' },
  { slug:'court-low-vintage-white', cat:'sneakers', stock:'in', brand:'Court Low', name:'Vintage White', grade:'Standard', img:'assets/Sneakers/court-low-vintage-white.webp' },
  { slug:'low-top-sneaker-velvet-brown', cat:'sneakers', stock:'in', brand:'Low-Top Sneaker', name:'Velvet Brown', grade:'Vault', img:'assets/Sneakers/low-top-sneaker-velvet-brown.webp' },
  { slug:'performance-runner-white-orange', cat:'sneakers', stock:'in', brand:'Performance Runner', name:'White Orange', grade:'Standard', img:'assets/Sneakers/performance-runner-white-orange.webp' },
  { slug:'performance-runner-rainbow-sole', cat:'sneakers', stock:'in', brand:'Performance Runner', name:'Rainbow Sole', grade:'Standard', img:'assets/Sneakers/performance-runner-rainbow-sole.webp' },
  { slug:'terrace-sneaker-grey', cat:'sneakers', stock:'in', brand:'Terrace Sneaker', name:'Grey', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-grey.webp' },
  ...
  // ---------- Apparel ----------
  { slug:'toh-crest-tee', cat:'apparel', brand:'TOH', name:'Crest Tee', grade:'Entry', img:'assets/Apparel/toh-crest-tee.webp' },
  { slug:'heavyweight-hoodie-oatmeal', cat:'apparel', brand:'Heavyweight Hoodie', name:'Oatmeal', grade:'Standard', img:'assets/Apparel/heavyweight-hoodie-oatmeal.webp' },
  { slug:'graphic-hoodie-pink-web', cat:'apparel', brand:'Graphic Hoodie', name:'Pink Web', grade:'Vault', img:'assets/Apparel/graphic-hoodie-pink-web.webp' },
  { slug:'overshirt-washed-black', cat:'apparel', brand:'Overshirt', name:'Washed Black', grade:'Standard', img:'assets/Apparel/overshirt-washed-black.webp' },
  { slug:'cotton-tee-basic-white', cat:'apparel', brand:'Cotton Tee', name:'Basic White', grade:'Entry', img:'assets/Apparel/cotton-tee-basic-white.webp' },
  { slug:'tech-hoodie-black', cat:'apparel', brand:'Tech Hoodie', name:'Black', grade:'Standard', img:'assets/Apparel/tech-hoodie-black.webp' },
  { slug:'graphic-hoodie-black-white', cat:'apparel', brand:'Graphic Hoodie', name:'Black & White', grade:'Vault', img:'assets/Apparel/graphic-hoodie-black-white.webp' },
  { slug:'full-zip-hoodie-camo', cat:'apparel', brand:'Full-Zip Hoodie', name:'Camo', grade:'Vault', img:'assets/Apparel/full-zip-hoodie-camo.webp' },
  { slug:'hooded-sweatshirt-brown', cat:'apparel', brand:'Hooded Sweatshirt', name:'Brown', grade:'Standard', img:'assets/Apparel/hooded-sweatshirt-brown.webp' },
  { slug:'graphic-tee-bear-print', cat:'apparel', brand:'Graphic Tee', name:'Bear Print', grade:'Standard', img:'assets/Apparel/graphic-tee-bear-print.webp' },
  { slug:'down-puffer-black', cat:'apparel', brand:'Down Puffer', name:'Black', grade:'Vault', img:'assets/Apparel/down-puffer-black.webp' },
  { slug:'crewneck-slate-grey', cat:'apparel', brand:'Crewneck', name:'Slate Grey', grade:'Vault', img:'assets/Apparel/crewneck-slate-grey.webp' },
  { slug:'logo-hoodie-red', cat:'apparel', brand:'Logo Hoodie', name:'Red', grade:'Vault', img:'assets/Apparel/logo-hoodie-red.webp' },
  { slug:'graphic-tee-8-ball', cat:'apparel', brand:'Graphic Tee', name:'8-Ball', grade:'Standard', img:'assets/Apparel/graphic-tee-8-ball.webp' },
  { slug:'graphic-tee-4-star', cat:'apparel', brand:'Graphic Tee', name:'4-Star', grade:'Standard', img:'assets/Apparel/graphic-tee-4-star.webp' },
  { slug:'cotton-tee-cream', cat:'apparel', brand:'Cotton Tee', name:'Cream', grade:'Standard', img:'assets/Apparel/cotton-tee-cream.webp' },
  { slug:'cotton-tee-black', cat:'apparel', brand:'Cotton Tee', name:'Black', grade:'Entry', img:'assets/Apparel/cotton-tee-black.webp' },
  { slug:'track-top-black-white', cat:'apparel', brand:'Track Top', name:'Black & White', grade:'Standard', img:'assets/Apparel/track-top-black-white.webp' },
  { slug:'crewneck-wreath-print', cat:'apparel', brand:'Crewneck', name:'Wreath Print', grade:'Vault', img:'assets/Apparel/crewneck-wreath-print.webp' },
  { slug:'graphic-tee-tri-logo', cat:'apparel', brand:'Graphic Tee', name:'Tri-Logo', grade:'Standard', img:'assets/Apparel/graphic-tee-tri-logo.webp' },
  { slug:'graphic-hoodie-black-web', cat:'apparel', brand:'Graphic Hoodie', name:'Black Web', grade:'Vault', img:'assets/Apparel/graphic-hoodie-black-web.webp' },
  { slug:'graphic-tee-black-cross', cat:'apparel', brand:'Graphic Tee', name:'Black Cross', grade:'Vault', img:'assets/Apparel/graphic-tee-black-cross.webp' },
  { slug:'graphic-tee-vintage-white', cat:'apparel', brand:'Graphic Tee', name:'Vintage White', grade:'Vault', img:'assets/Apparel/graphic-tee-vintage-white.webp' },
  { slug:'graphic-tee-grey-print', cat:'apparel', brand:'Graphic Tee', name:'Grey Print', grade:'Standard', img:'assets/Apparel/graphic-tee-grey-print.webp' },
  { slug:'tech-hoodie-grey', cat:'apparel', brand:'Tech Hoodie', name:'Grey', grade:'Vault', img:'assets/Apparel/tech-hoodie-grey.webp' },
  { slug:'tech-shell-jacket-black', cat:'apparel', brand:'Tech Shell Jacket', name:'Black', grade:'Vault', img:'assets/Apparel/tech-shell-jacket-black.webp' },
  { slug:'crewneck-heather-grey', cat:'apparel', brand:'Crewneck', name:'Heather Grey', grade:'Standard', img:'assets/Apparel/crewneck-heather-grey.webp' },
  { slug:'cotton-tee-white-logo', cat:'apparel', brand:'Cotton Tee', name:'White Logo', grade:'Entry', img:'assets/Apparel/cotton-tee-white-logo.webp' },
  // ---------- Bottomwear ----------
  { slug:'sweatpants-oatmeal', cat:'bottomwear', brand:'Sweatpants', name:'Oatmeal', grade:'Standard', img:'assets/Bottomwear/sweatpants-oatmeal.webp' },
  { slug:'cargo-pants-olive', cat:'bottomwear', brand:'Cargo Pants', name:'Olive', grade:'Vault', img:'assets/Bottomwear/cargo-pants-olive.webp' },
  { slug:'toh-baggy-denim-indigo', cat:'bottomwear', brand:'TOH', name:'Baggy Denim · Indigo', grade:'Entry', img:'assets/Bottomwear/toh-baggy-denim-indigo.webp' },
  { slug:'tech-joggers-black', cat:'bottomwear', brand:'Tech Joggers', name:'Black', grade:'Standard', img:'assets/Bottomwear/tech-joggers-black.webp' },
  { slug:'track-pants-black', cat:'bottomwear', brand:'Track Pants', name:'Black', grade:'Entry', img:'assets/Bottomwear/track-pants-black.webp' },
  { slug:'cargo-pants-beige', cat:'bottomwear', brand:'Cargo Pants', name:'Beige', grade:'Standard', img:'assets/Bottomwear/cargo-pants-beige.webp' },
  { slug:'straight-denim-mid-blue', cat:'bottomwear', brand:'Straight Denim', name:'Mid Blue', grade:'Standard', img:'assets/Bottomwear/straight-denim-mid-blue.webp' },
  { slug:'baggy-denim-washed-blue', cat:'bottomwear', brand:'Baggy Denim', name:'Washed Blue', grade:'Vault', img:'assets/Bottomwear/baggy-denim-washed-blue.webp' },
  { slug:'fleece-shorts-black', cat:'bottomwear', brand:'Fleece Shorts', name:'Black', grade:'Standard', img:'assets/Bottomwear/fleece-shorts-black.webp' },
  { slug:'sweat-shorts-grey', cat:'bottomwear', brand:'Sweat Shorts', name:'Grey', grade:'Entry', img:'assets/Bottomwear/sweat-shorts-grey.webp' },
  { slug:'work-pants-brown', cat:'bottomwear', brand:'Work Pants', name:'Brown', grade:'Standard', img:'assets/Bottomwear/work-pants-brown.webp' },
  { slug:'sport-shorts-black', cat:'bottomwear', brand:'Sport Shorts', name:'Black', grade:'Entry', img:'assets/Bottomwear/sport-shorts-black.webp' },
  { slug:'bootcut-denim-mid-blue', cat:'bottomwear', brand:'Bootcut Denim', name:'Mid Blue', grade:'Standard', img:'assets/Bottomwear/bootcut-denim-mid-blue.webp' },
  { slug:'cargo-shorts-khaki', cat:'bottomwear', brand:'Cargo Shorts', name:'Khaki', grade:'Standard', img:'assets/Bottomwear/cargo-shorts-khaki.webp' },
  { slug:'distressed-denim-indigo', cat:'bottomwear', brand:'Distressed Denim', name:'Indigo', grade:'Vault', img:'assets/Bottomwear/distressed-denim-indigo.webp' },
  { slug:'sweatpants-pink', cat:'bottomwear', brand:'Sweatpants', name:'Pink', grade:'Vault', img:'assets/Bottomwear/sweatpants-pink.webp' },
  { slug:'cargo-pants-slate', cat:'bottomwear', brand:'Cargo Pants', name:'Slate', grade:'Vault', img:'assets/Bottomwear/cargo-pants-slate.webp' },
  { slug:'track-pants-navy', cat:'bottomwear', brand:'Track Pants', name:'Navy', grade:'Standard', img:'assets/Bottomwear/track-pants-navy.webp' },
  { slug:'fleece-joggers-grey', cat:'bottomwear', brand:'Fleece Joggers', name:'Grey', grade:'Entry', img:'assets/Bottomwear/fleece-joggers-grey.webp' },
  { slug:'work-pants-black', cat:'bottomwear', brand:'Work Pants', name:'Black', grade:'Entry', img:'assets/Bottomwear/work-pants-black.webp' },
  // ---------- Accessories ----------
  { slug:'toh-crown-tote-cream', cat:'accessories', brand:'TOH', name:'Crown Tote · Cream', grade:'Entry', img:'assets/Accessories/toh-crown-tote-cream.webp' },
  { slug:'6-panel-cap-navy', cat:'accessories', brand:'6-Panel Cap', name:'Navy', grade:'Standard', img:'assets/Accessories/6-panel-cap-navy.webp' },
  { slug:'toh-crew-sock-3-pack', cat:'accessories', brand:'TOH', name:'Crew Sock 3-Pack', grade:'Entry', img:'assets/Accessories/toh-crew-sock-3-pack.webp' },
  { slug:'sunglasses-classic-black', cat:'accessories', brand:'Sunglasses', name:'Classic Black', grade:'Standard', img:'assets/Accessories/sunglasses-classic-black.webp' },
  { slug:'sunglasses-pilot-gold', cat:'accessories', brand:'Sunglasses', name:'Pilot Gold', grade:'Standard', img:'assets/Accessories/sunglasses-pilot-gold.webp' },
  { slug:'toh-double-buckle-leather-belt', cat:'accessories', brand:'TOH', name:'Double-Buckle Leather Belt', grade:'Standard', img:'assets/Accessories/toh-double-buckle-leather-belt.webp' },
  { slug:'fitted-cap-navy', cat:'accessories', brand:'Fitted Cap', name:'Navy', grade:'Standard', img:'assets/Accessories/fitted-cap-navy.webp' },
  { slug:'premium-wallet-brown-print', cat:'accessories', brand:'Premium Wallet', name:'Brown Print', grade:'Vault', img:'assets/Accessories/premium-wallet-brown-print.webp' },
  { slug:'card-holder-black-leather', cat:'accessories', brand:'Card Holder', name:'Black Leather', grade:'Vault', img:'assets/Accessories/card-holder-black-leather.webp' },
  { slug:'premium-wallet-black-leather', cat:'accessories', brand:'Premium Wallet', name:'Black Leather', grade:'Standard', img:'assets/Accessories/premium-wallet-black-leather.webp' },
  { slug:'toh-bifold-leather-wallet', cat:'accessories', brand:'TOH', name:'Bifold Leather Wallet', grade:'Entry', img:'assets/Accessories/toh-bifold-leather-wallet.webp' },
  { slug:'sports-watch-chronograph-black', cat:'accessories', brand:'Sports Watch', name:'Chronograph Black', grade:'Standard', img:'assets/Accessories/sports-watch-chronograph-black.webp' },
  { slug:'sports-watch-black-resin', cat:'accessories', brand:'Sports Watch', name:'Black Resin', grade:'Standard', img:'assets/Accessories/sports-watch-black-resin.webp' },
  { slug:'luxury-watch-silver-blue', cat:'accessories', brand:'Luxury Watch', name:'Silver & Blue', grade:'Vault', img:'assets/Accessories/luxury-watch-silver-blue.webp' },
  { slug:'crossbody-bag-black', cat:'accessories', brand:'Crossbody Bag', name:'Black', grade:'Standard', img:'assets/Accessories/crossbody-bag-black.webp' },
  { slug:'toh-ribbed-beanie', cat:'accessories', brand:'TOH', name:'Ribbed Beanie', grade:'Entry', img:'assets/Accessories/toh-ribbed-beanie.webp' },
  { slug:'bucket-hat-black', cat:'accessories', brand:'Bucket Hat', name:'Black', grade:'Standard', img:'assets/Accessories/bucket-hat-black.webp' },
  { slug:'knit-beanie-brown', cat:'accessories', brand:'Knit Beanie', name:'Brown', grade:'Standard', img:'assets/Accessories/knit-beanie-brown.webp' },
  { slug:'backpack-black', cat:'accessories', brand:'Backpack', name:'Black', grade:'Entry', img:'assets/Accessories/backpack-black.webp' },
  { slug:'duffle-bag-brown-print', cat:'accessories', brand:'Duffle Bag', name:'Brown Print', grade:'Vault', img:'assets/Accessories/duffle-bag-brown-print.webp' },
  { slug:'luxury-watch-steel-blue', cat:'accessories', brand:'Luxury Watch', name:'Steel Blue', grade:'Vault', img:'assets/Accessories/luxury-watch-steel-blue.webp' },
  { slug:'luxury-watch-gold-steel', cat:'accessories', brand:'Luxury Watch', name:'Gold & Steel', grade:'Vault', img:'assets/Accessories/luxury-watch-gold-steel.webp' },
  { slug:'cuban-link-chain-iced-silver', cat:'accessories', brand:'Cuban Link Chain', name:'Iced Silver', grade:'Standard', img:'assets/Accessories/cuban-link-chain-iced-silver.webp' },
  { slug:'card-holder-tan-chevron', cat:'accessories', brand:'Card Holder', name:'Tan Chevron', grade:'Vault', img:'assets/Accessories/card-holder-tan-chevron.webp' },
  { slug:'shoulder-bag-black-nylon', cat:'accessories', brand:'Shoulder Bag', name:'Black Nylon', grade:'Vault', img:'assets/Accessories/shoulder-bag-black-nylon.webp' },
  { slug:'sport-sunglasses-black', cat:'accessories', brand:'Sport Sunglasses', name:'Black', grade:'Standard', img:'assets/Accessories/sport-sunglasses-black.webp' },
];
