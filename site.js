...
window.PRODUCTS = [
  ...
  { slug:'high-top-sneaker-bred-toe', cat:'sneakers', brand:'High-Top Sneaker', name:'Bred Toe', grade:'Standard', img:'assets/Sneakers/high-top-sneaker-bred-toe.webp' },
  ...
  { slug:'low-top-sneaker-black-white', cat:'sneakers', brand:'Low-Top Sneaker', name:'Black & White', grade:'Entry', img:'assets/Sneakers/low-top-sneaker-black-white.webp' },
  ...
  { slug:'skate-low-panda', cat:'sneakers', brand:'Skate Low', name:'Panda', grade:'Standard', img:'assets/Sneakers/skate-low-panda.webp' },
  { slug:'court-sneaker-triple-white', cat:'sneakers', brand:'Court Sneaker', name:'Triple White', grade:'Entry', img:'assets/Sneakers/court-sneaker-triple-white.webp' },
  ...
  { slug:'low-top-sneaker-mocha', cat:'sneakers', brand:'Low-Top Sneaker', name:'Mocha', grade:'Vault', img:'assets/Sneakers/low-top-sneaker-mocha.webp' },
  ...
  { slug:'terrace-sneaker-white-black', cat:'sneakers', brand:'Terrace Sneaker', name:'White Black', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-white-black.webp' },
  ...
  { slug:'terrace-sneaker-black', cat:'sneakers', brand:'Terrace Sneaker', name:'Black', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-black.webp' },
  { slug:'terrace-sneaker-dark-green', cat:'sneakers', brand:'Terrace Sneaker', name:'Dark Green', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-dark-green.webp' },
  { slug:'retro-trainer-black-white', cat:'sneakers', brand:'Retro Trainer', name:'Black White', grade:'Entry', img:'assets/Sneakers/retro-trainer-black-white.webp' },
  { slug:'retro-runner-cream-navy', cat:'sneakers', brand:'Retro Runner', name:'Cream Navy', grade:'Standard', img:'assets/Sneakers/retro-runner-cream-navy.webp' },
  { slug:'retro-runner-cream-maroon', cat:'sneakers', brand:'Retro Runner', name:'Cream Maroon', grade:'Standard', img:'assets/Sneakers/retro-runner-cream-maroon.webp' },
  { slug:'retro-runner-black-cream', cat:'sneakers', brand:'Retro Runner', name:'Black Cream', grade:'Standard', img:'assets/Sneakers/retro-runner-black-cream.webp' },
  { slug:'retro-runner-black', cat:'sneakers', brand:'Retro Runner', name:'Black', grade:'Standard', img:'assets/Sneakers/retro-runner-black.webp' },
  { slug:'retro-runner-white', cat:'sneakers', brand:'Retro Runner', name:'White', grade:'Standard', img:'assets/Sneakers/retro-runner-white.webp' },
  { slug:'court-sneaker-triple-black', cat:'sneakers', brand:'Court Sneaker', name:'Triple Black', grade:'Entry', img:'assets/Sneakers/court-sneaker-triple-black.webp' },
  { slug:'court-low-vintage-white', cat:'sneakers', brand:'Court Low', name:'Vintage White', grade:'Standard', img:'assets/Sneakers/court-low-vintage-white.webp' },
  { slug:'low-top-sneaker-velvet-brown', cat:'sneakers', brand:'Low-Top Sneaker', name:'Velvet Brown', grade:'Vault', img:'assets/Sneakers/low-top-sneaker-velvet-brown.webp' },
  { slug:'performance-runner-white-orange', cat:'sneakers', brand:'Performance Runner', name:'White Orange', grade:'Standard', img:'assets/Sneakers/performance-runner-white-orange.webp' },
  { slug:'performance-runner-rainbow-sole', cat:'sneakers', brand:'Performance Runner', name:'Rainbow Sole', grade:'Standard', img:'assets/Sneakers/performance-runner-rainbow-sole.webp' },
  { slug:'terrace-sneaker-grey', cat:'sneakers', brand:'Terrace Sneaker', name:'Grey', grade:'Standard', img:'assets/Sneakers/terrace-sneaker-grey.webp' },
