...
window.PRODUCTS = [
  ...
  { slug:'nike-dunk-low-panda', cat:'sneakers', stock:'in', brand:'Skate Low', name:'Panda', grade:'Standard', img:'assets/Sneakers/nike-dunk-low-panda.webp' },
  ...
  { slug:'adidas-samba-black', cat:'sneakers', stock:'in', brand:'Terrace Sneaker', name:'Black', grade:'Standard', img:'assets/Sneakers/adidas-samba-black.webp' },
  { slug:'adidas-samba-green', cat:'sneakers', stock:'in', brand:'Terrace Sneaker', name:'Dark Green', grade:'Standard', img:'assets/Sneakers/adidas-samba-green.webp' },
  { slug:'onitsuka-mexico66-black', cat:'sneakers', stock:'in', brand:'Retro Trainer', name:'Black White', grade:'Entry', img:'assets/Sneakers/onitsuka-mexico66-black.webp' },
  { slug:'nb-327-navy', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Cream Navy', grade:'Standard', img:'assets/Sneakers/nb-327-navy.webp' },
  { slug:'nb-327-maroon', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Cream Maroon', grade:'Standard', img:'assets/Sneakers/nb-327-maroon.webp' },
  { slug:'nb-327-black', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Black Cream', grade:'Standard', img:'assets/Sneakers/nb-327-black.webp' },
  { slug:'nb-530-black', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'Black', grade:'Standard', img:'assets/Sneakers/nb-530-black.webp' },
  { slug:'nb-530-white', cat:'sneakers', stock:'in', brand:'Retro Runner', name:'White', grade:'Standard', img:'assets/Sneakers/nb-530-white.webp' },
  { slug:'nike-af1-black', cat:'sneakers', stock:'in', brand:'Court Sneaker', name:'Triple Black', grade:'Entry', img:'assets/Sneakers/nike-af1-black.webp' },
  { slug:'nike-blazer-vintage', cat:'sneakers', stock:'in', brand:'Court Low', name:'Vintage White', grade:'Standard', img:'assets/Sneakers/nike-blazer-vintage.webp' },
