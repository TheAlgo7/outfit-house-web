...
window.PRODUCTS = [
  ...
  { slug:'graphic-tee-cream-motto-back-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Cream Motto Back Print', grade:'Standard', img:'assets/Apparel/graphic-tee-cream-motto-back-print.webp' },
  { slug:'graphic-tee-white-typographic-back-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'White Typographic Back Print', grade:'Standard', img:'assets/Apparel/graphic-tee-white-typographic-back-print.webp' },
  { slug:'graphic-tee-black-varsity-12-back-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Black Varsity 12 Back Print', grade:'Standard', img:'assets/Apparel/graphic-tee-black-varsity-12-back-print.webp' },
  { slug:'graphic-tee-cyan-cartoon-back-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Cyan Cartoon Back Print', grade:'Standard', img:'assets/Apparel/graphic-tee-cyan-cartoon-back-print.webp' },
  { slug:'graphic-tee-dark-green-grid-back-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Dark Green Grid Back Print', grade:'Standard', img:'assets/Apparel/graphic-tee-dark-green-grid-back-print.webp' },
  { slug:'collar-polo-white-navy-trim', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Collar Polo', name:'White Navy Trim', grade:'Standard', img:'assets/Apparel/collar-polo-white-navy-trim.webp' },
  { slug:'collar-polo-salmon-pink', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Collar Polo', name:'Salmon Pink', grade:'Standard', img:'assets/Apparel/collar-polo-salmon-pink.webp' },
  { slug:'collar-polo-tan-vertical-wordmark', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Collar Polo', name:'Tan Vertical Wordmark', grade:'Standard', img:'assets/Apparel/collar-polo-tan-vertical-wordmark.webp' },
  { slug:'collar-polo-royal-blue-trim', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Collar Polo', name:'Royal Blue Trim', grade:'Standard', img:'assets/Apparel/collar-polo-royal-blue-trim.webp' },
  { slug:'collar-polo-orange-red-trim', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Collar Polo', name:'Orange-Red Trim', grade:'Standard', img:'assets/Apparel/collar-polo-orange-red-trim.webp' },
  { slug:'long-sleeve-training-top-yellow', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Long Sleeve Training Top', name:'Yellow', grade:'Standard', img:'assets/Apparel/long-sleeve-training-top-yellow.webp' },
  { slug:'long-sleeve-training-top-teal', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Long Sleeve Training Top', name:'Teal', grade:'Standard', img:'assets/Apparel/long-sleeve-training-top-teal.webp' },
  { slug:'cotton-tee-plain-white', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Cotton Tee', name:'Plain White', grade:'Entry', img:'assets/Apparel/cotton-tee-plain-white.webp' },
  { slug:'graphic-tee-beige-oval-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Beige Oval Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-beige-oval-chest-print.webp' },
  { slug:'graphic-tee-black-monogram-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Black Monogram Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-black-monogram-chest-print.webp' },
  { slug:'graphic-tee-bright-blue-chest-patch', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Bright Blue Chest Patch', grade:'Standard', img:'assets/Apparel/graphic-tee-bright-blue-chest-patch.webp' },
  { slug:'graphic-tee-red-leaping-cat-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Red Leaping Cat Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-red-leaping-cat-chest-print.webp' },
  { slug:'cotton-tee-blue-minimal-chest-mark', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Cotton Tee', name:'Blue Minimal Chest Mark', grade:'Entry', img:'assets/Apparel/cotton-tee-blue-minimal-chest-mark.webp' },
  { slug:'graphic-tee-black-crest-wordmark-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Black Crest Wordmark Print', grade:'Standard', img:'assets/Apparel/graphic-tee-black-crest-wordmark-print.webp' },
  { slug:'graphic-tee-off-white-leaping-cat-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Off-White Leaping Cat Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-off-white-leaping-cat-chest-print.webp' },
  { slug:'graphic-tee-dark-grey-varsity-12-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Dark Grey Varsity 12 Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-dark-grey-varsity-12-chest-print.webp' },
  { slug:'graphic-tee-red-monogram-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Red Monogram Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-red-monogram-chest-print.webp' },
  { slug:'graphic-tee-dark-trefoil-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Dark Trefoil Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-dark-trefoil-chest-print.webp' },
  { slug:'graphic-tee-yellow-trefoil-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Yellow Trefoil Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-yellow-trefoil-chest-print.webp' },
  { slug:'graphic-tee-black-block-text-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Black Block Text Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-black-block-text-chest-print.webp' },
  { slug:'graphic-tee-grey-varsity-12-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Grey Varsity 12 Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-grey-varsity-12-chest-print.webp' },
  { slug:'graphic-tee-brown-monogram-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'Brown Monogram Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-brown-monogram-chest-print.webp' },
  { slug:'graphic-tee-white-varsity-12-chest-print', cat:'apparel', stock:'in', sizes:'S, M, L, XL', brand:'Graphic Tee', name:'White Varsity 12 Chest Print', grade:'Standard', img:'assets/Apparel/graphic-tee-white-varsity-12-chest-print.webp' },
  ...
  { slug:'straight-denim-dark-indigo', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34', brand:'Straight Denim', name:'Dark Indigo', grade:'Standard', img:'assets/Bottomwear/straight-denim-dark-indigo.webp', imgs:['assets/Bottomwear/straight-denim-dark-indigo-2.webp', 'assets/Bottomwear/straight-denim-dark-indigo-3.webp'] },
  { slug:'bootcut-trouser-black', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34', brand:'Bootcut Trouser', name:'Black', grade:'Vault', img:'assets/Bottomwear/bootcut-trouser-black.webp', imgs:['assets/Bottomwear/bootcut-trouser-black-2.webp', 'assets/Bottomwear/bootcut-trouser-black-3.webp'] },
  { slug:'bootcut-trouser-pure-white', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34, 36', brand:'Bootcut Trouser', name:'Pure White', grade:'Vault', img:'assets/Bottomwear/bootcut-trouser-pure-white.webp', imgs:['assets/Bottomwear/bootcut-trouser-pure-white-2.webp', 'assets/Bottomwear/bootcut-trouser-pure-white-3.webp'] },
  { slug:'straight-denim-black', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34', brand:'Straight Denim', name:'Black', grade:'Standard', img:'assets/Bottomwear/straight-denim-black.webp', imgs:['assets/Bottomwear/straight-denim-black-2.webp', 'assets/Bottomwear/straight-denim-black-3.webp'] },
  { slug:'bootcut-trouser-brown', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34', brand:'Bootcut Trouser', name:'Brown', grade:'Standard', img:'assets/Bottomwear/bootcut-trouser-brown.webp', imgs:['assets/Bottomwear/bootcut-trouser-brown-2.webp', 'assets/Bottomwear/bootcut-trouser-brown-3.webp'] },
  ...
  { slug:'straight-denim-ice-blue', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34', brand:'Straight Denim', name:'Ice Blue', grade:'Standard', img:'assets/Bottomwear/straight-denim-ice-blue.webp', imgs:['assets/Bottomwear/straight-denim-ice-blue-2.webp', 'assets/Bottomwear/straight-denim-ice-blue-3.webp'] },
  { slug:'straight-denim-faded-black', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34', brand:'Straight Denim', name:'Faded Black', grade:'Standard', img:'assets/Bottomwear/straight-denim-faded-black.webp', imgs:['assets/Bottomwear/straight-denim-faded-black-2.webp', 'assets/Bottomwear/straight-denim-faded-black-3.webp'] },
  { slug:'distressed-denim-dark-indigo', cat:'bottomwear', stock:'in', sizes:'28, 30, 32, 34', brand:'Distressed Denim', name:'Dark Indigo', grade:'Vault', img:'assets/Bottomwear/distressed-denim-dark-indigo.webp', imgs:['assets/Bottomwear/distressed-denim-dark-indigo-2.webp', 'assets/Bottomwear/distressed-denim-dark-indigo-3.webp'] },
  { slug:'straight-denim-charcoal-grey', cat:'bottomwear', stock:'in', sizes:'34', brand:'Straight Denim', name:'Charcoal Grey', grade:'Standard', img:'assets/Bottomwear/straight-denim-charcoal-grey.webp', imgs:['assets/Bottomwear/straight-denim-charcoal-grey-2.webp', 'assets/Bottomwear/straight-denim-charcoal-grey-3.webp'] },
  { slug:'slim-denim-dark-charcoal', cat:'bottomwear', stock:'in', sizes:'34', brand:'Slim Denim', name:'Dark Charcoal', grade:'Vault', img:'assets/Bottomwear/slim-denim-dark-charcoal.webp', imgs:['assets/Bottomwear/slim-denim-dark-charcoal-2.webp', 'assets/Bottomwear/slim-denim-dark-charcoal-3.webp', 'assets/Bottomwear/slim-denim-dark-charcoal-4.webp'] },
  ...
  { slug:'slim-denim-charcoal', cat:'bottomwear', stock:'in', sizes:'28, 32', brand:'Slim Denim', name:'Charcoal', grade:'Entry', img:'assets/Bottomwear/slim-denim-charcoal.webp', imgs:['assets/Bottomwear/slim-denim-charcoal-2.webp', 'assets/Bottomwear/slim-denim-charcoal-3.webp'] },
  // ---------- Accessories ----------
  ...
  { slug:'sunglasses-chunky-square-white-temple-blue-tint', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Chunky Square White Temple Blue Tint', grade:'Standard', img:'assets/Accessories/sunglasses-chunky-square-white-temple-blue-tint.webp', imgs:['assets/Accessories/sunglasses-chunky-square-white-temple-blue-tint-2.webp'] },
  { slug:'sunglasses-chunky-square-tortoise-fade-brown-gradient', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Chunky Square Tortoise Fade Brown Gradient', grade:'Standard', img:'assets/Accessories/sunglasses-chunky-square-tortoise-fade-brown-gradient.webp', imgs:['assets/Accessories/sunglasses-chunky-square-tortoise-fade-brown-gradient-2.webp'] },
  { slug:'sunglasses-chunky-square-black-temple-blue-tint', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Chunky Square Black Temple Blue Tint', grade:'Standard', img:'assets/Accessories/sunglasses-chunky-square-black-temple-blue-tint.webp', imgs:['assets/Accessories/sunglasses-chunky-square-black-temple-blue-tint-2.webp'] },
  { slug:'sunglasses-flat-top-square-gold-stud-black', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Flat-Top Square Gold Stud Black', grade:'Standard', img:'assets/Accessories/sunglasses-flat-top-square-gold-stud-black.webp', imgs:['assets/Accessories/sunglasses-flat-top-square-gold-stud-black-2.webp'] },
  { slug:'sunglasses-rounded-wayfarer-gold-plaque-black', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Rounded Wayfarer Gold Plaque Black', grade:'Standard', img:'assets/Accessories/sunglasses-rounded-wayfarer-gold-plaque-black.webp', imgs:['assets/Accessories/sunglasses-rounded-wayfarer-gold-plaque-black-2.webp'] },
  { slug:'sunglasses-matte-square-crest-emblem-black', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Matte Square Crest Emblem Black', grade:'Standard', img:'assets/Accessories/sunglasses-matte-square-crest-emblem-black.webp', imgs:['assets/Accessories/sunglasses-matte-square-crest-emblem-black-2.webp'] },
  { slug:'sunglasses-flat-top-square-clear-smoke-gradient', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Flat-Top Square Clear Smoke Gradient', grade:'Standard', img:'assets/Accessories/sunglasses-flat-top-square-clear-smoke-gradient.webp', imgs:['assets/Accessories/sunglasses-flat-top-square-clear-smoke-gradient-2.webp'] },
  { slug:'sunglasses-faceted-octagon-silver-accent-black', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Faceted Octagon Silver Accent Black', grade:'Standard', img:'assets/Accessories/sunglasses-faceted-octagon-silver-accent-black.webp', imgs:['assets/Accessories/sunglasses-faceted-octagon-silver-accent-black-2.webp'] },
  { slug:'sunglasses-chunky-square-gold-t-hinge-blue-tint', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Chunky Square Gold T-Hinge Blue Tint', grade:'Standard', img:'assets/Accessories/sunglasses-chunky-square-gold-t-hinge-blue-tint.webp', imgs:['assets/Accessories/sunglasses-chunky-square-gold-t-hinge-blue-tint-2.webp'] },
  { slug:'sunglasses-chunky-square-gold-t-hinge-black', cat:'accessories', stock:'in', brand:'Sunglasses', name:'Chunky Square Gold T-Hinge Black', grade:'Standard', img:'assets/Accessories/sunglasses-chunky-square-gold-t-hinge-black.webp', imgs:['assets/Accessories/sunglasses-chunky-square-gold-t-hinge-black-2.webp'] },
  { slug:'leather-belt-matte-black-plaque', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Matte Black Plaque', grade:'Standard', img:'assets/Accessories/leather-belt-matte-black-plaque.webp', imgs:['assets/Accessories/leather-belt-matte-black-plaque-2.webp'] },
  { slug:'leather-belt-check-plaque-gold', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Check Plaque Gold', grade:'Vault', img:'assets/Accessories/leather-belt-check-plaque-gold.webp', imgs:['assets/Accessories/leather-belt-check-plaque-gold-2.webp'] },
  { slug:'leather-belt-gunmetal-monogram', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Gunmetal Monogram', grade:'Vault', img:'assets/Accessories/leather-belt-gunmetal-monogram.webp', imgs:['assets/Accessories/leather-belt-gunmetal-monogram-2.webp'] },
  { slug:'leather-belt-gold-frame-plaque', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Gold Frame Plaque', grade:'Standard', img:'assets/Accessories/leather-belt-gold-frame-plaque.webp', imgs:['assets/Accessories/leather-belt-gold-frame-plaque-2.webp'] },
  { slug:'leather-belt-ribbed-plaque', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Ribbed Plaque', grade:'Standard', img:'assets/Accessories/leather-belt-ribbed-plaque.webp', imgs:['assets/Accessories/leather-belt-ribbed-plaque-2.webp'] },
  { slug:'leather-belt-brushed-gunmetal', cat:'accessories', stock:'sold', brand:'Leather Belt', name:'Brushed Gunmetal', grade:'Standard', img:'assets/Accessories/leather-belt-brushed-gunmetal.webp', imgs:['assets/Accessories/leather-belt-brushed-gunmetal-2.webp'] },
  { slug:'leather-belt-gold-cat-medallion', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Gold Cat Medallion', grade:'Vault', img:'assets/Accessories/leather-belt-gold-cat-medallion.webp', imgs:['assets/Accessories/leather-belt-gold-cat-medallion-2.webp'] },
  { slug:'leather-belt-oval-cut-out', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Oval Cut-Out', grade:'Standard', img:'assets/Accessories/leather-belt-oval-cut-out.webp', imgs:['assets/Accessories/leather-belt-oval-cut-out-2.webp'] },
  { slug:'leather-belt-eagle-medallion', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Eagle Medallion', grade:'Vault', img:'assets/Accessories/leather-belt-eagle-medallion.webp', imgs:['assets/Accessories/leather-belt-eagle-medallion-2.webp'] },
  { slug:'leather-belt-silver-h-frame', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Silver H-Frame', grade:'Vault', img:'assets/Accessories/leather-belt-silver-h-frame.webp', imgs:['assets/Accessories/leather-belt-silver-h-frame-2.webp'] },
  { slug:'leather-belt-gunmetal-h-frame', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Gunmetal H-Frame', grade:'Vault', img:'assets/Accessories/leather-belt-gunmetal-h-frame.webp', imgs:['assets/Accessories/leather-belt-gunmetal-h-frame-2.webp'] },
  { slug:'leather-belt-gunmetal-frame', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Gunmetal Frame', grade:'Standard', img:'assets/Accessories/leather-belt-gunmetal-frame.webp', imgs:['assets/Accessories/leather-belt-gunmetal-frame-2.webp'] },
  { slug:'leather-belt-leaping-cat-plaque', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Leaping Cat Plaque', grade:'Standard', img:'assets/Accessories/leather-belt-leaping-cat-plaque.webp', imgs:['assets/Accessories/leather-belt-leaping-cat-plaque-2.webp'] },
  { slug:'leather-belt-black-monogram-plaque', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Black Monogram Plaque', grade:'Vault', img:'assets/Accessories/leather-belt-black-monogram-plaque.webp', imgs:['assets/Accessories/leather-belt-black-monogram-plaque-2.webp'] },
  { slug:'leather-belt-gold-flag-plaque', cat:'accessories', stock:'in', brand:'Leather Belt', name:'Gold Flag Plaque', grade:'Standard', img:'assets/Accessories/leather-belt-gold-flag-plaque.webp', imgs:['assets/Accessories/leather-belt-gold-flag-plaque-2.webp'] },
];
